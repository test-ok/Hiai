...
public class ModelManager {
    ...
    public static boolean loadJNISo() {
        try {
            ...
            Log.e(TAG, "successfully load hiaijni native library");
            return true;
    ...
    public static native int loadModelSync(String modelName, String offlineModelFile, AssetManager mgr, boolean isMixModel);
    ...
    public static native void loadModelAsync(String modelName, String offlineModelFile, AssetManager mgr, boolean isMixModel);
